...
twitch_miner = TwitchChannelPointsMiner(
    username="squidspongebob",
    password="LOLman335",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1261780363886461018/sYjGk06ADJgJNKEoikOee9rCLha3hc7BqJuOXpYjXvFdpaioZoA86t64suz6CrUOMiyH",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
